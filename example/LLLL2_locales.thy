...
locale ll3 =
  fixes tlsx :: "'lsx itself"
  fixes tlix :: "'lix itself"
  fixes tllx :: "'llx itself"
  fixes tljx :: "'ljx itself"
  fixes tlijx :: "'lijx itself"
  fixes tptx :: "'ptx itself"
  fixes tpnx :: "'pnx itself"
 
 fixes ll_valid_ll3local :: "('lix, 'llx, 'ljx, 'ljix, 'lsx, 'ptx, 'pnx) ll set"
  
 fixes ll_validl_ll3local :: "(qan * (('lix, 'llx, 'ljx, 'ljix, 'lsx, 'ptx, 'pnx) ll list)) set"
